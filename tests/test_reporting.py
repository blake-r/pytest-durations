...
def expected_report_rows() -> list[ReportRowT]:
    return [
        ...
        ReportRowT("0:00:04.400000", "grand total", "6", "0:00:00.700000", "0:00:01.400000", "0:00:00.100000", "0:00:01.260000", "0:00:01.330000", "0:00:01.386000"),
    ]
...
def test_get_report_rows_time_format_short(sample_measurements):
    ...
    assert result[1:] == [
        ...
        ReportRowT("0:00:04", "grand total", "6", "0:00:00", "0:00:01", "0:00:00", "0:00:01", "0:00:01", "0:00:01"),
    ]
