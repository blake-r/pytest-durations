...
def expected_report_rows() -> list[ReportRowT]:
    return [
        ReportRowT("total", "name", "num", "min", "med", "p90", "p95", "p99", "max"),
        ReportRowT("0:00:03.700000", "fixture2", "3", "0:00:01.100000", "0:00:01.200000", "0:00:01.360000", "0:00:01.380000", "0:00:01.396000", "0:00:01.400000"),
        ReportRowT("0:00:00.700000", "fixture1", "3", "0:00:00.100000", "0:00:00.200000", "0:00:00.360000", "0:00:00.380000", "0:00:00.396000", "0:00:00.400000"),
        ReportRowT("0:00:04.400000", "grand total", "6", "0:00:00.100000", "0:00:00.700000", "0:00:01.260000", "0:00:01.330000", "0:00:01.386000", "0:00:01.400000"),
    ]
...
def test_get_report_rows_time_format_short(sample_measurements):
    ...
    assert result[1:] == [
        ...
        ReportRowT("0:00:04", "grand total", "6", "0:00:00", "0:00:00", "0:00:01", "0:00:01", "0:00:01", "0:00:01"),
    ]
